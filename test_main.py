...
def main():
    ...
    # dbi.insert_Kundeordre(conn, 3, "2023-03-23 19:00:00", 1, "2023-04-03", 1, "Mosjøen", "Bodø")
    # dbi.insert_Billett(conn, 1, 2, 2, 3)
    
    # dbf.print_orders(conn, "ola.nordmann@fuckyou.com")

    dbf.print_available_seats(conn, 2, "2023-04-03", "Trondheim S", "Bodø")
